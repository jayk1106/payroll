...
const Login = () => {
    ...
    const onLoginHandler = async (values) => {
        ...
        if(data && data.error){
            errorContent = <Alert message={data.error} type="error" showIcon closable />; 
        }
    }
        ...
        <div className={style.container}>
            ...
            <Form
                ...
                <Form.Item label="Password" name="password" required>
                    <Input.Password className={style.input} placeholder="Enter your Password" />
                </Form.Item>
                <Form.Item>
                    <Button className={style.btn} type="primary" htmlType='submit' loading={isLoadding}>Login</Button>
                </Form.Item>
            </Form>
